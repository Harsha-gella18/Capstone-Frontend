    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-noir-950 dark:via-noir-900 dark:to-noir-800 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white dark:bg-noir-900 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-800 p-10 relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <div className="space-y-1 bg-gray-50 dark:bg-noir-800 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-green-600 dark:text-green-400 font-bold text-sm">Email Verified Successfully!</p>
                <p className="text-green-600 dark:text-green-400 text-xs mt-1">Redirecting to login page...</p>
              </div>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-bold text-gray-900 dark:text-white mb-4 text-center">
            ...
            <div className="flex gap-3 justify-center">
              {otp.map((digit, index) => (
                <input
                  ...
                  className="w-12 h-12 text-center text-xl font-bold bg-gray-50 dark:bg-noir-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-400 focus:border-transparent transition duration-300 text-gray-900 dark:text-white"
                />
              ))}
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-2 font-medium">Didn't receive the code?</p>
          {canResend ? (
            <button
              onClick={handleResendOTP}
              disabled={loading}
              className="text-gray-900 dark:text-white hover:text-black dark:hover:text-gray-200 font-bold transition duration-300 disabled:opacity-50 underline underline-offset-2"
            >
              Resend OTP
            </button>
          ) : (
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
              Resend available in <span className="font-bold text-gray-900 dark:text-white">{resendTimer}s</span>
            </p>
          )}
        </div>
